...
class FavoriteAdapter(private val list:List<FavoriteMovie>,private val listener:RecyclerViewClickListener) : RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder>() {
